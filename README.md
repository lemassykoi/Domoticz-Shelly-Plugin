...
<img width="930" height="76" alt="image" src="https://github.com/user-attachments/assets/1fe5b2bc-1bad-4c6e-9280-e7c0b3981b63" />

The plugin is using WebSocket to communicate with the device
You need `websockets` package installed :
